...
import com.prueba.backendShoeStore.Service.Operational.ProductService;
...
@CrossOrigin("*")
@RestController
@RequestMapping("/api/v1/store/operational/product/")
public class ProductController extends BaseController<Product> {
	...
	@GetMapping("filters")
	public List<Product> filters(@RequestParam(required=false) String nameProduct, @RequestParam(required=false) String status){
		return service.filters(nameProduct, status);
	}
}
